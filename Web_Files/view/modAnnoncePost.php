...
<?php foreach ($data as $info) : ?>
    <?php if ($info['annonceId'] == $_SESSION['postId']) : ?>
        ...
        <div class="center">
            <form method="post" class="centerForm was-validated" action="/myProfile/modAnnonce/modAnnoncePost/modAnnoncePush/" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input <?php if ($info['animaux'] == "on") echo "checked"; ?> type="checkbox" class="form-check-input" name="animaux"
                           id="animaux">
                    <br>
                    <label for="vehicle" class="form-check-label">Véhicule : </label>
                    <input <?php if ($info['vehicle'] == "on") echo "checked"; ?> type="checkbox" class="form-check-input" name="vehicle" id="vehicle">
                    <br>
                    <label for="info" class="form-check-label">Informatique : </label>
                    <input <?php if ($info['info'] == "on") echo "checked"; ?> type="checkbox" class="form-check-input" name="info" id="info">
                    <br>
