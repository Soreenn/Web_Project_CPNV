...
<?php foreach ($data as $info) : ?>
    ...
    <?php if (substr_count($info['email'], ".") > 1) {
        ...
        <div>
            ...
            <br>
            <div class="center">
                <form method="post" class="centerForm was-validated" action="/formulaireDeContact/sendMail/">
                    <input type="hidden" name="toMail" value="<?= $info['email'] ?>">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Adresse e-mail :</label>
                        <input required type="email" class="form-control" name="email" value="<?= $_SESSION['email'] ?>" id="exampleInputEmail1">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea style="resize: none" required class="form-control" name="content" id="content"></textarea>
